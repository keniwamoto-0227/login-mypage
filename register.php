...
<html lang="ja">
    ...
    <body>
        <header>
            ...
            <div class="login"><a herf="login.php"></a></div>
        </header>
            ...
            <form action="register_confirm.php" method="post" enctype="multipart/form-data">
                <div class="form_contents">
                    ...
                    <div class="password">
                        ...
                        <input type="password" class="formbox" size="40" name="confirm_password" id="confirm_password" oninput="ConfirmPassword(this)" required>
                    </div>
                    ...
                    <div class="toroku">
                        <input type="submit" class="submit_button" size="35" valie="登録する">
                    </div>
                </div>
            </form>
        </main>
